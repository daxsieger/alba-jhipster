...
import { IAttachmentCategory } from 'app/entities/Alba/attachment-category/attachment-category.model';
import { AttachmentCategoryService } from 'app/entities/Alba/attachment-category/service/attachment-category.service';
import { IRefugee } from 'app/entities/Alba/refugee/refugee.model';
import { RefugeeService } from 'app/entities/Alba/refugee/service/refugee.service';
import { IOperator } from 'app/entities/Alba/operator/operator.model';
import { OperatorService } from 'app/entities/Alba/operator/service/operator.service';
import { IEvent } from 'app/entities/Alba/event/event.model';
import { EventService } from 'app/entities/Alba/event/service/event.service';
  ...
  setFileData(event: Event, field: string, isImage: boolean): void {
    this.dataUtils.loadFileToForm(event, this.editForm, field, isImage).subscribe({
      error: (err: FileLoadError) =>
        this.eventManager.broadcast(new EventWithContent<AlertError>('albaApp.error', { ...err, key: 'error.file.' + err.key })),
    });
  }
